...
//        uatPutMessageToTwoQueues();
        ...
        String content = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                "<esb>\n" +
                "    <Header>\n" +
                "        <ClientId>RIW</ClientId>\n" +
                "        <CServiceType>Inquiry</CServiceType>\n" +
                "        <CMsgType>Account</CMsgType>\n" +
                "        <CTxnId>L0000013388</CTxnId>\n" +
                "        <CDateTime>20190114172706</CDateTime>\n" +
                "        <TxnId>20190114172706</TxnId>\n" +
                "    </Header>\n" +
                "    <Body>\n" +
                "        <Region>0018</Region>\n" +
                ...
                "        <KWBKCustLoginId/>\n" +
                "        <KWBKSupervisorId/>\n" +
                "        <AcctId>1810071000000480180406</AcctId>\n" +
        ...
        String xcontent = "<esb>\n" +
                ...
                "        <CServiceType>Inquiry</CServiceType>\n" +
                "        <CMsgType>Account</CMsgType>\n" +
                "        <CTxnId>L0000015405</CTxnId>\n" +
                "        <CDateTime>20190114172011</CDateTime>\n" +
                "        <TxnId>20190114172011</TxnId>\n" +
                "    </Header>\n" +
                "    <Body>\n" +
                "        <Region>0018</Region>\n" +
                "        <CustLoginId>9961</CustLoginId>\n" +
                ...
                "        <KWBKCustLoginId/>\n" +
                "        <KWBKSupervisorId/>\n" +
                "        <AcctId>1810069400000000142609800</AcctId>\n" +
    ...
    private static void uatPutMessageToTwoQueues() throws JMSException, MalformedURLException {
        ...
        final String MQ_SERVER_QUEUE_OUT = "Q.RIW.SERVER.OUT";
        final String MQ_CCDT_URL = "file:/D:/projects/riw/riw_git/src/main/misc/CCDT_UAT_RIW.TAB";
        final String MQ_SERVER_HOSTS = "10.30.201.101,10.30.201.102";
        final String MQ_SERVER_PORT = "1415";
        final String MQ_SERVER_QUEUE_IN = "Q.RIW.SERVER.IN";
        ...
        try {
            Files.newDirectoryStream(
                    ...
                    .forEach(xml -> {
                        ...
                        try {
                            // put94aMsgToQueue(serverMQQueueConnectionFactory, MSG_RIW_94a);
    ...
    private static void testAccountInquiry(String content) throws JMSException {
        ...
        final String HK_QUEUE_IN = "Q.RIW.IN.SHFB";
        final String HK_QUEUE_OUT = "Q.RIW.OUT.SHFB";
        final String SG_QUEUE_IN = "Q.RIW.IN";
        final String SG_QUEUE_OUT = "Q.RIW.OUT";
